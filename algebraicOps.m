...
partitionDataToBins[data_,binSize_]:= Partition[data,binSize,binSize, 1, {}]


partitionDataToBins::usage= "partitionDataToBins[data,binSize] partition data into bins";
